...
def force_push():
    print("[START] STARTING DIRECT PUSH TO HUGGING FACE SPACE...")
    ...
    print("[CONFIG] Configuring Remote 'hf_target'...")
    ...
    # 4. Push
    print("[PUSH] PUSHING CODE (v4.4)... This may take a moment.")
    try:
        ...
        if res.returncode == 0:
            ...
            print("[WARNING] PUSH COMPLETED WITH WARNINGS/ERRORS:")
            print(res.stderr)
