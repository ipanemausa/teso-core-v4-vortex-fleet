import{r as l,j as t}from"./index-Dk_rv2kE.js";const d="/assets/landing_bg-DqNP_8jJ.png";function c({onEnter:n}){const[i,s]=l.useState(!1),[e,a]=l.useState(!1);l.useEffect(()=>{const o=setTimeout(()=>{a(!0)},1e3);return()=>clearTimeout(o)},[]);const p=()=>{s(!0),setTimeout(()=>{n()},2e3)};return t.jsxs("div",{style:{width:"100vw",minHeight:"100vh",backgroundImage:`url(${d})`,backgroundSize:"cover",backgroundPosition:"center",backgroundAttachment:"fixed",color:"#fff",display:"flex",flexDirection:"column",justifyContent:"space-between",alignItems:"center",fontFamily:"'Outfit', 'Segoe UI', sans-serif",padding:"40px 20px",position:"relative",overflowY:"auto",overflowX:"hidden"},children:[t.jsx("style",{children:`
